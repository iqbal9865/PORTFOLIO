...
const ExpEdu = () => {
    return (
        <div>
             <div class='about-main pt-5'>
             <div className="row pb-3 w-75 m-auto">
                <div className="col-md-6 experience">
                    <h3 className='text-start  px-3 mb-5'>Experience</h3>
                    <p className='text-start px-3'>01 Jan 2020 - 30 April 2020</p>
                    <h4 className='text-start px-3'>Front-End Developer (Intern) - Source9</h4>
